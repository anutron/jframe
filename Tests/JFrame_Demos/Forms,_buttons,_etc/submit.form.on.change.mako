...
<html>
	...
	<body>
		...
		<form action="/test/?project=jframe_demos&path=/JFrame.Window_Tests/submit.form.on.change.mako" method="post" style="margin: 6px 0px 0px;" data-filters="SubmitOnChange">
		...
		<form action="/test/?project=jframe_demos&path=/JFrame.Window_Tests/submit.form.on.change.mako" method="post" style="margin: 6px 0px 0px;">
