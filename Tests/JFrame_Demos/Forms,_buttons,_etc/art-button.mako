	...
	<body>
		<div class="jframe_padded">
			...
			<div data-filters="ArtButtonBar" style="clear:both">
				<a data-filters="ArtButton" href="/" style="background: url(${get_asset_url('jframe_containers', 'info.png')}) left 50%; padding: 6px 6px 6px 20px; margin: 10px 0px;" data-icon-styles="{'width': 14, 'height': 14}">I'm a button!</a>
				<a data-filters="ArtButton" href="/" style="background: url(${get_asset_url('jframe_containers', 'error.png')}) left 50%; padding: 6px 6px 6px 20px; margin: 10px 0px;" data-icon-styles="{'width': 14, 'height': 14}">I'm a button too!</a>
				<a data-filters="ArtButton" href="/" style="background: url(${get_asset_url('jframe_containers', 'info.png')}) left 50%; padding: 6px 6px 6px 20px; margin: 10px 0px;" data-icon-styles="{'width': 14, 'height': 14}">I'm a button!</a>
				<a data-filters="ArtButton" href="/" style="background: url(${get_asset_url('jframe_containers', 'error.png')}) left 50%; padding: 6px 6px 6px 20px; margin: 10px 0px;" data-icon-styles="{'width': 14, 'height': 14}">I'm a button too!</a>
			</div>
