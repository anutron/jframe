...
provides: [JFrame.DoubleClickDelegate]
requires: [/JFrame, Widgets/Element.Data]
script: JFrame.DoubleClickDelegate.js

...
*/

JFrame.doubleClickHandler = function(jframe, event, delegate){
...
JFrame.addGlobalFilters({
	...
	doubleClickDelegates: function(container) {
		...
		var handler = function(e, delegate){
			JFrame.doubleClickHandler(this, e, delegate);
		}.bind(this);
